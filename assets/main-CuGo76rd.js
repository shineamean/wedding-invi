 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bs(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function bl(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
...
</defs>`,V.innerText="Preview backend running in this workspace."),V.setAttribute("id",b)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",I):I()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fl="FirebaseError";class Le extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=Fl,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ba.prototype.create)}}class Ba{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?Ul(o,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new Le(s,l,r)}}function Ul(n,t){return n.replace(Bl,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Bl=/\{\$([^}]+)}/g;function lr(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(Co(o)&&Co(a)){if(!lr(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Co(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ql{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const r=new Cl;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:e});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){const e=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),r=(t==null?void 0:t.optional)??!1;if(this.isInitialized(e)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:e})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if($l(t))try{this.getOrInitializeService({instanceIdentifier:ce})}catch{}for(const[e,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(e);try{const o=this.getOrInitializeService({instanceIdentifier:s});r.resolve(o)}catch{}}}}clearInstance(t=ce){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ce){return this.instances.has(t)}getOptions(t=ce){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:e});for(const[o,a]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(o);r===l&&a.resolve(s)}return s}onInit(t,e){const r=this.normalizeInstanceIdentifier(e),s=this.onInitCallbacks.get(r)??new Set;s.add(t),this.onInitCallbacks.set(r,s);const o=this.instances.get(r);return o&&t(o,r),()=>{s.delete(t)}}invokeOnInitCallbacks(t,e){const r=this.onInitCallbacks.get(e);if(r)for(const s of r)try{s(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:jl(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=ce){return this.component?this.component.multipleInstances?t:ce:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function jl(n){return n===ce?void 0:n}function $l(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qh=Mh;function za(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r={name:vs,automaticDataCollectionEnabled:!0,...t},s=r.name;if(typeof s!="string"||!s)throw Qt.create("bad-app-name",{appName:String(s)});if(e||(e=Ua()),!e)throw Qt.create("no-options");const o=hr.get(s);if(o){if(lr(e,o.options)&&lr(r,o.config))return o;throw Qt.create("duplicate-app",{appName:s})}const a=new zl(s);for(const h of Ts.values())a.addComponent(h);const l=new Bh(e,r,a);return hr.set(s,l),l}function jh(n=vs){const t=hr.get(n);if(!t&&n===vs&&Ua())return za();if(!t)throw Qt.create("no-app",{appName:n});return t}function Se(n,t,e){let r=Oh[n]??n;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${t}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Bt.warn(a.join(" "));return}dr(new gn(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jh(n){dr(new gn("platform-logger",t=>new oh(t),"PRIVATE")),dr(new gn("heartbeat",t=>new Wh(t),"PRIVATE")),Se(Es,Do,n),Se(Es,Do,"esm2020"),Se("fire-js","")}Jh("");var Zh="firebase",td="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Se(Zh,td,"app");var xo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Wa,un,Qa,rr,Is,Xa,Ya,Ja;(function(){var n,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(i,u,c){return i==Array.prototype||i==Object.prototype||(i[u]=c.value),i};function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof Yn=="object"&&Yn];for(var u=0;u<i.length;++u){var c=i[u];if(c&&c.Math==Math)return c}throw Error("Cannot find global object")}var r=e(this);function s(i,u){if(u)t:{var c=r;i=i.split(".");for(var d=0;d<i.length-1;d++){var T=i[d];if(!(T in c))break t;c=c[T]}i=i[i.length-1],d=c[i],u=u(d),u!=d&&u!=null&&t(c,i,{configurable:!0,writable:!0,value:u})}}function o(i,u){i instanceof String&&(i+="");var c=0,d=!1,T={next:function(){if(!d&&c<i.length){var R=c++;return{value:u(R,i[R]),done:!1}}return d=!0,{done:!0,value:void 0}}};return T[Symbol.iterator]=function(){return T},T}s("Array.prototype.values",function(i){return i||function(){return o(this,function(u,c){return c})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function h(i){var u=typeof i;return u=u!="object"?u:i?Array.isArray(i)?"array":u:"null",u=="array"||u=="object"&&typeof i.length=="number"}function f(i){var u=typeof i;return u=="object"&&i!=null||u=="function"}function p(i,u,c){return i.call.apply(i.bind,arguments)}function I(i,u,c){if(!i)throw Error();if(2<arguments.length){var d=Array.prototype.slice.call(arguments,2);return function(){var T=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(T,d),i.apply(u,T)}}return function(){return i.apply(u,arguments)}}function A(i,u,c){return A=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?p:I,A.apply(null,arguments)}function b(i,u){var c=Array.prototype.slice.call(arguments,1);return function(){var d=c.slice();return d.push.apply(d,arguments),i.apply(this,d)}}function V(i,u){function c(){}c.prototype=u.prototype,i.aa=u.prototype,i.prototype=new c,i.prototype.constructor=i,i.Qb=function(d,T,R){for(var P=Array(arguments.length-2),W=2;W<arguments.length;W++)P[W-2]=arguments[W];return u.prototype[T].apply(d,P)}}function M(i){const u=i.length;if(0<u){const c=Array(u);for(let d=0;d<u;d++)c[d]=i[d];return c}return[]}function D(i,u){for(let c=1;c<arguments.length;c++){const d=arguments[c];if(h(d)){const T=i.length||0,R=d.length||0;i.length=T+R;for(let P=0;P<R;P++)i[T+P]=d[P]}else i.push(d)}}class K{constructor(u,c){this.i=u,this.j=c,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function U(i){return/^[\s\xa0]*$/.test(i)}function z(){var i=l.navigator;return i&&(i=i.userAgent)?i:""}function et(i){return et[" "](i),i}et[" "]=function(){};var Ot=z().indexOf("Gecko")!=-1&&!(z().toLowerCase().indexOf("webkit")!=-1&&z().indexOf("Edge")==-1)&&!(z().indexOf("Trident")!=-1||z().indexOf("MSIE")!=-1)&&z().indexOf("Edge")==-1;function ut(i,u,c){for(const d in i)u.call(c,i[d],d,i)}function v(i,u){for(const c in i)u.call(void 0,i[c],c,i)}function m(i){const u={};for(const c in i)u[c]=i[c];return u}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function y(i,u){let c,d;for(let T=1;T<arguments.length;T++){d=arguments[T];for(c in d)i[c]=d[c];for(let R=0;R<_.length;R++)c=_[R],Object.prototype.hasOwnProperty.call(d,c)&&(i[c]=d[c])}}function E(i){var u=1;i=i.split(":");const c=[];for(;0<u&&i.length;)c.push(i.shift()),u--;return i.length&&c.push(i.join(":")),c}function w(i){l.setTimeout(()=>{throw i},0)}function g(){var i=Lr;let u=null;return i.g&&(u=i.g,i.g=i.g.next,i.g||(i.h=null),u.next=null),u}class xt{constructor(){this.h=this.g=null}add(u,c){const d=$e.get();d.set(u,c),this.h?this.h.next=d:this.g=d,this.h=d}}var $e=new K(()=>new Rc,i=>i.reset());class Rc{constructor(){this.next=this.g=this.h=null}set(u,c){this.h=u,this.g=c,this.next=null}reset(){this.next=this.g=this.h=null}}let ze,Ge=!1,Lr=new xt,wi=()=>{const i=l.Promise.resolve(void 0);ze=()=>{i.then(Sc)}};var Sc=()=>{for(var i;i=g();){try{i.h.call(i.g)}catch(c){w(c)}var u=$e;u.j(i),100>u.h&&(u.h++,i.next=u.g,u.g=i)}Ge=!1};function $t(){this.s=this.s,this.C=this.C}$t.prototype.s=!1,$t.prototype.ma=function(){this.s||(this.s=!0,this.N())},$t.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ft(i,u){this.type=i,this.g=this.target=u,this.defaultPrevented=!1}ft.prototype.h=function(){this.defaultPrevented=!0};var Cc=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var i=!1,u=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const c=()=>{};l.addEventListener("test",c,u),l.removeEventListener("test",c,u)}catch{}return i}();function He(i,u){if(ft.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i){var c=this.type=i.type,d=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;if(this.target=i.target||i.srcElement,this.g=u,u=i.relatedTarget){if(Ot){t:{try{et(u.nodeName);var T=!0;break t}catch{}T=!1}T||(u=null)}}else c=="mouseover"?u=i.fromElement:c=="mouseout"&&(u=i.toElement);this.relatedTarget=u,d?(this.clientX=d.clientX!==void 0?d.clientX:d.pageX,this.clientY=d.clientY!==void 0?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=typeof i.pointerType=="string"?i.pointerType:bc[i.pointerType]||"",this.state=i.state,this.i=i,i.defaultPrevented&&He.aa.h.call(this)}}V(He,ft);var bc={2:"touch",3:"pen",4:"mouse"};He.prototype.h=function(){He.aa.h.call(this);var i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var Nn="closure_listenable_"+(1e6*Math.random()|0),Pc=0;function Vc(i,u,c,d,T){this.listener=i,this.proxy=null,this.src=u,this.type=c,this.capture=!!d,this.ha=T,this.key=++Pc,this.da=this.fa=!1}function kn(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Mn(i){this.src=i,this.g={},this.h=0}Mn.prototype.add=function(i,u,c,d,T){var R=i.toString();i=this.g[R],i||(i=this.g[R]=[],this.h++);var P=Ur(i,u,d,T);return-1<P?(u=i[P],c||(u.fa=!1)):(u=new Vc(u,this.src,R,!!d,T),u.fa=c,i.push(u)),u};function Fr(i,u){var c=u.type;if(c in i.g){var d=i.g[c],T=Array.prototype.indexOf.call(d,u,void 0),R;(R=0<=T)&&Array.prototype.splice.call(d,T,1),R&&(kn(u),i.g[c].length==0&&(delete i.g[c],i.h--))}}function Ur(i,u,c,d){for(var T=0;T<i.length;++T){var R=i[T];if(!R.da&&R.listener==u&&R.capture==!!c&&R.ha==d)return T}return-1}var Br="closure_lm_"+(1e6*Math.random()|0),qr={};function Ai(i,u,c,d,T){if(Array.isArray(u)){for(var R=0;R<u.length;R++)Ai(i,u[R],c,d,T);return null}return c=Ci(c),i&&i[Nn]?i.K(u,c,f(d)?!!d.capture:!1,T):Dc(i,u,c,!1,d,T)}function Dc(i,u,c,d,T,R){if(!u)throw Error("Invalid event type");var P=f(T)?!!T.capture:!!T,W=$r(i);if(W||(i[Br]=W=new Mn(i)),c=W.add(u,c,d,P,R),c.proxy)return c;if(d=Nc(),c.proxy=d,d.src=i,d.listener=c,i.addEventListener)Cc||(T=P),T===void 0&&(T=!1),i.addEventListener(u.toString(),d,T);else if(i.attachEvent)i.attachEvent(Si(u.toString()),d);else if(i.addListener&&i.removeListener)i.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return c}function Nc(){function i(c){return u.call(i.src,i.listener,c)}const u=kc;return i}function Ri(i,u,c,d,T){if(Array.isArray(u))for(var R=0;R<u.length;R++)Ri(i,u[R],c,d,T);else d=f(d)?!!d.capture:!!d,c=Ci(c),i&&i[Nn]?(i=i.i,u=String(u).toString(),u in i.g&&(R=i.g[u],c=Ur(R,c,d,T),-1<c&&(kn(R[c]),Array.prototype.splice.call(R,c,1),R.length==0&&(delete i.g[u],i.h--)))):i&&(i=$r(i))&&(u=i.g[u.toString()],i=-1,u&&(i=Ur(u,c,d,T)),(c=-1<i?u[i]:null)&&jr(c))}function jr(i){if(typeof i!="number"&&i&&!i.da){var u=i.src;if(u&&u[Nn])Fr(u.i,i);else{var c=i.type,d=i.proxy;u.removeEventListener?u.removeEventListener(c,d,i.capture):u.detachEvent?u.detachEvent(Si(c),d):u.addListener&&u.removeListener&&u.removeListener(d),(c=$r(u))?(Fr(c,i),c.h==0&&(c.src=null,u[Br]=null)):kn(i)}}}function Si(i){return i in qr?qr[i]:qr[i]="on"+i}function kc(i,u){if(i.da)i=!0;else{u=new He(u,this);var c=i.listener,d=i.ha||i.src;i.fa&&jr(i),i=c.call(d,u)}return i}function $r(i){return i=i[Br],i instanceof Mn?i:null}var zr="__closure_events_fn_"+(1e9*Math.random()>>>0);function Ci(i){return typeof i=="function"?i:(i[zr]||(i[zr]=function(u){return i.handleEvent(u)}),i[zr])}function mt(){$t.call(this),this.i=new Mn(this),this.M=this,this.F=null}V(mt,$t),mt.prototype[Nn]=!0,mt.prototype.removeEventListener=function(i,u,c,d){Ri(this,i,u,c,d)};function vt(i,u){var c,d=i.F;if(d)for(c=[];d;d=d.F)c.push(d);if(i=i.M,d=u.type||u,typeof u=="string")u=new ft(u,i);else if(u instanceof ft)u.target=u.target||i;else{var T=u;u=new ft(d,i),y(u,T)}if(T=!0,c)for(var R=c.length-1;0<=R;R--){var P=u.g=c[R];T=On(P,d,!0,u)&&T}if(P=u.g=i,T=On(P,d,!0,u)&&T,T=On(P,d,!1,u)&&T,c)for(R=0;R<c.length;R++)P=u.g=c[R],T=On(P,d,!1,u)&&T}mt.prototype.N=function(){if(mt.aa.N.call(this),this.i){var i=this.i,u;for(u in i.g){for(var c=i.g[u],d=0;d<c.length;d++)kn(c[d]);delete i.g[u],i.h--}}this.F=null},mt.prototype.K=function(i,u,c,d){return this.i.add(String(i),u,!1,c,d)},mt.prototype.L=function(i,u,c,d){return this.i.add(String(i),u,!0,c,d)};function On(i,u,c,d){if(u=i.i.g[String(u)],!u)return!0;u=u.concat();for(var T=!0,R=0;R<u.length;++R){var P=u[R];if(P&&!P.da&&P.capture==c){var W=P.listener,ct=P.ha||P.src;P.fa&&Fr(i.i,P),T=W.call(ct,d)!==!1&&T}}return T&&!d.defaultPrevented}function bi(i,u,c){if(typeof i=="function")c&&(i=A(i,c));else if(i&&typeof i.handleEvent=="function")i=A(i.handleEvent,i);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:l.setTimeout(i,u||0)}function Pi(i){i.g=bi(()=>{i.g=null,i.i&&(i.i=!1,Pi(i))},i.l);const u=i.h;i.h=null,i.m.apply(null,u)}class Mc extends $t{constructor(u,c){super(),this.m=u,this.l=c,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:Pi(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ke(i){$t.call(this),this.h=i,this.g={}}V(Ke,$t);var Vi=[];function Di(i){ut(i.g,function(u,c){this.g.hasOwnProperty(c)&&jr(u)},i),i.g={}}Ke.prototype.N=function(){Ke.aa.N.call(this),Di(this)},Ke.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Gr=l.JSON.stringify,Oc=l.JSON.parse,xc=class{stringify(i){return l.JSON.stringify(i,void 0)}parse(i){return l.JSON.parse(i,void 0)}};function Hr(){}Hr.prototype.h=null;function Ni(i){return i.h||(i.h=i.i())}function ki(){}var We={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Kr(){ft.call(this,"d")}V(Kr,ft);function Wr(){ft.call(this,"c")}V(Wr,ft);var ie={},Mi=null;function xn(){return Mi=Mi||new mt}ie.La="serverreachability";function Oi(i){ft.call(this,ie.La,i)}V(Oi,ft);function Qe(i){const u=xn();vt(u,new Oi(u))}ie.STAT_EVENT="statevent";function xi(i,u){ft.call(this,ie.STAT_EVENT,i),this.stat=u}V(xi,ft);function Tt(i){const u=xn();vt(u,new xi(u,i))}ie.Ma="timingevent";function Li(i,u){ft.call(this,ie.Ma,i),this.size=u}V(Li,ft);function Xe(i,u){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){i()},u)}function Ye(){this.g=!0}Ye.prototype.xa=function(){this.g=!1};function Lc(i,u,c,d,T,R){i.info(function(){if(i.g)if(R)for(var P="",W=R.split("&"),ct=0;ct<W.length;ct++){var G=W[ct].split("=");if(1<G.length){var pt=G[0];G=G[1];var gt=pt.split("_");P=2<=gt.length&&gt[1]=="type"?P+(pt+"="+G+"&"):P+(pt+"=redacted&")}}else P=null;else P=R;return"XMLHTTP REQ ("+d+") [attempt "+T+"]: "+u+`
`+c+`
`+P})}function Fc(i,u,c,d,T,R,P){i.info(function(){return"XMLHTTP RESP ("+d+") [ attempt "+T+"]: "+u+`
`+c+`
`+R+" "+P})}function ye(i,u,c,d){i.info(function(){return"XMLHTTP TEXT ("+u+"): "+Bc(i,c)+(d?" "+d:"")})}function Uc(i,u){i.info(function(){return"TIMEOUT: "+u})}Ye.prototype.info=function(){};function Bc(i,u){if(!i.g)return u;if(!u)return null;try{var c=JSON.parse(u);if(c){for(i=0;i<c.length;i++)if(Array.isArray(c[i])){var d=c[i];if(!(2>d.length)){var T=d[1];if(Array.isArray(T)&&!(1>T.length)){var R=T[0];if(R!="noop"&&R!="stop"&&R!="close")for(var P=1;P<T.length;P++)T[P]=""}}}}return Gr(c)}catch{return u}}var Ln={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Fi={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Qr;function Fn(){}V(Fn,Hr),Fn.prototype.g=function(){return new XMLHttpRequest},Fn.prototype.i=function(){return{}},Qr=new Fn;function zt(i,u,c,d){this.j=i,this.i=u,this.l=c,this.R=d||1,this.U=new Ke(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ui}function Ui(){this.i=null,this.g="",this.h=!1}var Bi={},Xr={};function Yr(i,u,c){i.L=1,i.v=jn(Lt(u)),i.m=c,i.P=!0,qi(i,null)}function qi(i,u){i.F=Date.now(),Un(i),i.A=Lt(i.v);var c=i.A,d=i.R;Array.isArray(d)||(d=[String(d)]),eo(c.i,"t",d),i.C=0,c=i.j.J,i.h=new Ui,i.g=vo(i.j,c?u:null,!i.m),0<i.O&&(i.M=new Mc(A(i.Y,i,i.g),i.O)),u=i.U,c=i.g,d=i.ca;var T="readystatechange";Array.isArray(T)||(T&&(Vi[0]=T.toString()),T=Vi);for(var R=0;R<T.length;R++){var P=Ai(c,T[R],d||u.handleEvent,!1,u.h||u);if(!P)break;u.g[P.key]=P}u=i.H?m(i.H):{},i.m?(i.u||(i.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.A,i.u,i.m,u)):(i.u="GET",i.g.ea(i.A,i.u,null,u)),Qe(),Lc(i.i,i.u,i.A,i.l,i.R,i.m)}zt.prototype.ca=function(i){i=i.target;const u=this.M;u&&Ft(i)==3?u.j():this.Y(i)},zt.prototype.Y=function(i){try{if(i==this.g)t:{const gt=Ft(this.g);var u=this.g.Ba();const Te=this.g.Z();if(!(3>gt)&&(gt!=3||this.g&&(this.h.h||this.g.oa()||uo(this.g)))){this.J||gt!=4||u==7||(u==8||0>=Te?Qe(3):Qe(2)),Jr(this);var c=this.g.Z();this.X=c;e:if(ji(this)){var d=uo(this.g);i="";var T=d.length,R=Ft(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){oe(this),Je(this);var P="";break e}this.h.i=new l.TextDecoder}for(u=0;u<T;u++)this.h.h=!0,i+=this.h.i.decode(d[u],{stream:!(R&&u==T-1)});d.length=0,this.h.g+=i,this.C=0,P=this.h.g}else P=this.g.oa();if(this.o=c==200,Fc(this.i,this.u,this.A,this.l,this.R,gt,c),this.o){if(this.T&&!this.K){e:{if(this.g){var W,ct=this.g;if((W=ct.g?ct.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!U(W)){var G=W;break e}}G=null}if(c=G)ye(this.i,this.l,c,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Zr(this,c);else{this.o=!1,this.s=3,Tt(12),oe(this),Je(this);break t}}if(this.P){c=!0;let St;for(;!this.J&&this.C<P.length;)if(St=qc(this,P),St==Xr){gt==4&&(this.s=4,Tt(14),c=!1),ye(this.i,this.l,null,"[Incomplete Response]");break}else if(St==Bi){this.s=4,Tt(15),ye(this.i,this.l,P,"[Invalid Chunk]"),c=!1;break}else ye(this.i,this.l,St,null),Zr(this,St);if(ji(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),gt!=4||P.length!=0||this.h.h||(this.s=1,Tt(16),c=!1),this.o=this.o&&c,!c)ye(this.i,this.l,P,"[Invalid Chunked Response]"),oe(this),Je(this);else if(0<P.length&&!this.W){this.W=!0;var pt=this.j;pt.g==this&&pt.ba&&!pt.M&&(pt.j.info("Great, no buffering proxy detected. Bytes received: "+P.length),is(pt),pt.M=!0,Tt(11))}}else ye(this.i,this.l,P,null),Zr(this,P);gt==4&&oe(this),this.o&&!this.J&&(gt==4?go(this.j,this):(this.o=!1,Un(this)))}else sl(this.g),c==400&&0<P.indexOf("Unknown SID")?(this.s=3,Tt(12)):(this.s=0,Tt(13)),oe(this),Je(this)}}}catch{}finally{}};function ji(i){return i.g?i.u=="GET"&&i.L!=2&&i.j.Ca:!1}function qc(i,u){var c=i.C,d=u.indexOf(`
`,c);return d==-1?Xr:(c=Number(u.substring(c,d)),isNaN(c)?Bi:(d+=1,d+c>u.length?Xr:(u=u.slice(d,d+c),i.C=d+c,u)))}zt.prototype.cancel=function(){this.J=!0,oe(this)};function Un(i){i.S=Date.now()+i.I,$i(i,i.I)}function $i(i,u){if(i.B!=null)throw Error("WatchDog timer not null");i.B=Xe(A(i.ba,i),u)}function Jr(i){i.B&&(l.clearTimeout(i.B),i.B=null)}zt.prototype.ba=function(){this.B=null;const i=Date.now();0<=i-this.S?(Uc(this.i,this.A),this.L!=2&&(Qe(),Tt(17)),oe(this),this.s=2,Je(this)):$i(this,this.S-i)};function Je(i){i.j.G==0||i.J||go(i.j,i)}function oe(i){Jr(i);var u=i.M;u&&typeof u.ma=="function"&&u.ma(),i.M=null,Di(i.U),i.g&&(u=i.g,i.g=null,u.abort(),u.ma())}function Zr(i,u){try{var c=i.j;if(c.G!=0&&(c.g==i||ts(c.h,i))){if(!i.K&&ts(c.h,i)&&c.G==3){try{var d=c.Da.g.parse(u)}catch{d=null}if(Array.isArray(d)&&d.length==3){var T=d;if(T[0]==0){t:if(!c.u){if(c.g)if(c.g.F+3e3<i.F)Wn(c),Hn(c);else break t;ss(c),Tt(18)}}else c.za=T[1],0<c.za-c.T&&37500>T[2]&&c.F&&c.v==0&&!c.C&&(c.C=Xe(A(c.Za,c),6e3));if(1>=Hi(c.h)&&c.ca){try{c.ca()}catch{}c.ca=void 0}}else ue(c,11)}else if((i.K||c.g==i)&&Wn(c),!U(u))for(T=c.Da.g.parse(u),u=0;u<T.length;u++){let G=T[u];if(c.T=G[0],G=G[1],c.G==2)if(G[0]=="c"){c.K=G[1],c.ia=G[2];const pt=G[3];pt!=null&&(c.la=pt,c.j.info("VER="+c.la));const gt=G[4];gt!=null&&(c.Aa=gt,c.j.info("SVER="+c.Aa));const Te=G[5];Te!=null&&typeof Te=="number"&&0<Te&&(d=1.5*Te,c.L=d,c.j.info("backChannelRequestTimeoutMs_="+d)),d=c;const St=i.g;if(St){const Xn=St.g?St.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Xn){var R=d.h;R.g||Xn.indexOf("spdy")==-1&&Xn.indexOf("quic")==-1&&Xn.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(es(R,R.h),R.h=null))}if(d.D){const os=St.g?St.g.getResponseHeader("X-HTTP-Session-Id"):null;os&&(d.ya=os,X(d.I,d.D,os))}}c.G=3,c.l&&c.l.ua(),c.ba&&(c.R=Date.now()-i.F,c.j.info("Handshake RTT: "+c.R+"ms")),d=c;var P=i;if(d.qa=Eo(d,d.J?d.ia:null,d.W),P.K){Ki(d.h,P);var W=P,ct=d.L;ct&&(W.I=ct),W.B&&(Jr(W),Un(W)),d.g=P}else mo(d);0<c.i.length&&Kn(c)}else G[0]!="stop"&&G[0]!="close"||ue(c,7);else c.G==3&&(G[0]=="stop"||G[0]=="close"?G[0]=="stop"?ue(c,7):rs(c):G[0]!="noop"&&c.l&&c.l.ta(G),c.v=0)}}Qe(4)}catch{}}var jc=class{constructor(i,u){this.g=i,this.map=u}};function zi(i){this.l=i||10,l.PerformanceNavigationTiming?(i=l.performance.getEntriesByType("navigation"),i=0<i.length&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Gi(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function Hi(i){return i.h?1:i.g?i.g.size:0}function ts(i,u){return i.h?i.h==u:i.g?i.g.has(u):!1}function es(i,u){i.g?i.g.add(u):i.h=u}function Ki(i,u){i.h&&i.h==u?i.h=null:i.g&&i.g.has(u)&&i.g.delete(u)}zi.prototype.cancel=function(){if(this.i=Wi(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Wi(i){if(i.h!=null)return i.i.concat(i.h.D);if(i.g!=null&&i.g.size!==0){let u=i.i;for(const c of i.g.values())u=u.concat(c.D);return u}return M(i.i)}function $c(i){if(i.V&&typeof i.V=="function")return i.V();if(typeof Map<"u"&&i instanceof Map||typeof Set<"u"&&i instanceof Set)return Array.from(i.values());if(typeof i=="string")return i.split("");if(h(i)){for(var u=[],c=i.length,d=0;d<c;d++)u.push(i[d]);return u}u=[],c=0;for(d in i)u[c++]=i[d];return u}function zc(i){if(i.na&&typeof i.na=="function")return i.na();if(!i.V||typeof i.V!="function"){if(typeof Map<"u"&&i instanceof Map)return Array.from(i.keys());if(!(typeof Set<"u"&&i instanceof Set)){if(h(i)||typeof i=="string"){var u=[];i=i.length;for(var c=0;c<i;c++)u.push(c);return u}u=[],c=0;for(const d in i)u[c++]=d;return u}}}function Qi(i,u){if(i.forEach&&typeof i.forEach=="function")i.forEach(u,void 0);else if(h(i)||typeof i=="string")Array.prototype.forEach.call(i,u,void 0);else for(var c=zc(i),d=$c(i),T=d.length,R=0;R<T;R++)u.call(void 0,d[R],c&&c[R],i)}var Xi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Gc(i,u){if(i){i=i.split("&");for(var c=0;c<i.length;c++){var d=i[c].indexOf("="),T=null;if(0<=d){var R=i[c].substring(0,d);T=i[c].substring(d+1)}else R=i[c];u(R,T?decodeURIComponent(T.replace(/\+/g," ")):"")}}}function ae(i){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,i instanceof ae){this.h=i.h,Bn(this,i.j),this.o=i.o,this.g=i.g,qn(this,i.s),this.l=i.l;var u=i.i,c=new en;c.i=u.i,u.g&&(c.g=new Map(u.g),c.h=u.h),Yi(this,c),this.m=i.m}else i&&(u=String(i).match(Xi))?(this.h=!1,Bn(this,u[1]||"",!0),this.o=Ze(u[2]||""),this.g=Ze(u[3]||"",!0),qn(this,u[4]),this.l=Ze(u[5]||"",!0),Yi(this,u[6]||"",!0),this.m=Ze(u[7]||"")):(this.h=!1,this.i=new en(null,this.h))}ae.prototype.toString=function(){var i=[],u=this.j;u&&i.push(tn(u,Ji,!0),":");var c=this.g;return(c||u=="file")&&(i.push("//"),(u=this.o)&&i.push(tn(u,Ji,!0),"@"),i.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c=this.s,c!=null&&i.push(":",String(c))),(c=this.l)&&(this.g&&c.charAt(0)!="/"&&i.push("/"),i.push(tn(c,c.charAt(0)=="/"?Wc:Kc,!0))),(c=this.i.toString())&&i.push("?",c),(c=this.m)&&i.push("#",tn(c,Xc)),i.join("")};function Lt(i){return new ae(i)}function Bn(i,u,c){i.j=c?Ze(u,!0):u,i.j&&(i.j=i.j.replace(/:$/,""))}function qn(i,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);i.s=u}else i.s=null}function Yi(i,u,c){u instanceof en?(i.i=u,Yc(i.i,i.h)):(c||(u=tn(u,Qc)),i.i=new en(u,i.h))}function X(i,u,c){i.i.set(u,c)}function jn(i){return X(i,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),i}function Ze(i,u){return i?u?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function tn(i,u,c){return typeof i=="string"?(i=encodeURI(i).replace(u,Hc),c&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function Hc(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var Ji=/[#\/\?@]/g,Kc=/[#\?:]/g,Wc=/[#\?]/g,Qc=/[#\?@]/g,Xc=/#/g;function en(i,u){this.h=this.g=null,this.i=i||null,this.j=!!u}function Gt(i){i.g||(i.g=new Map,i.h=0,i.i&&Gc(i.i,function(u,c){i.add(decodeURIComponent(u.replace(/\+/g," ")),c)}))}n=en.prototype,n.add=function(i,u){Gt(this),this.i=null,i=Ee(this,i);var c=this.g.get(i);return c||this.g.set(i,c=[]),c.push(u),this.h+=1,this};function Zi(i,u){Gt(i),u=Ee(i,u),i.g.has(u)&&(i.i=null,i.h-=i.g.get(u).length,i.g.delete(u))}function to(i,u){return Gt(i),u=Ee(i,u),i.g.has(u)}n.forEach=function(i,u){Gt(this),this.g.forEach(function(c,d){c.forEach(function(T){i.call(u,T,d,this)},this)},this)},n.na=function(){Gt(this);const i=Array.from(this.g.values()),u=Array.from(this.g.keys()),c=[];for(let d=0;d<u.length;d++){const T=i[d];for(let R=0;R<T.length;R++)c.push(u[d])}return c},n.V=function(i){Gt(this);let u=[];if(typeof i=="string")to(this,i)&&(u=u.concat(this.g.get(Ee(this,i))));else{i=Array.from(this.g.values());for(let c=0;c<i.length;c++)u=u.concat(i[c])}return u},n.set=function(i,u){return Gt(this),this.i=null,i=Ee(this,i),to(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[u]),this.h+=1,this},n.get=function(i,u){return i?(i=this.V(i),0<i.length?String(i[0]):u):u};function eo(i,u,c){Zi(i,u),0<c.length&&(i.i=null,i.g.set(Ee(i,u),M(c)),i.h+=c.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],u=Array.from(this.g.keys());for(var c=0;c<u.length;c++){var d=u[c];const R=encodeURIComponent(String(d)),P=this.V(d);for(d=0;d<P.length;d++){var T=R;P[d]!==""&&(T+="="+encodeURIComponent(String(P[d]))),i.push(T)}}return this.i=i.join("&")};function Ee(i,u){return u=String(u),i.j&&(u=u.toLowerCase()),u}function Yc(i,u){u&&!i.j&&(Gt(i),i.i=null,i.g.forEach(function(c,d){var T=d.toLowerCase();d!=T&&(Zi(this,d),eo(this,T,c))},i)),i.j=u}function Jc(i,u){const c=new Ye;if(l.Image){const d=new Image;d.onload=b(Ht,c,"TestLoadImage: loaded",!0,u,d),d.onerror=b(Ht,c,"TestLoadImage: error",!1,u,d),d.onabort=b(Ht,c,"TestLoadImage: abort",!1,u,d),d.ontimeout=b(Ht,c,"TestLoadImage: timeout",!1,u,d),l.setTimeout(function(){d.ontimeout&&d.ontimeout()},1e4),d.src=i}else u(!1)}function Zc(i,u){const c=new Ye,d=new AbortController,T=setTimeout(()=>{d.abort(),Ht(c,"TestPingServer: timeout",!1,u)},1e4);fetch(i,{signal:d.signal}).then(R=>{clearTimeout(T),R.ok?Ht(c,"TestPingServer: ok",!0,u):Ht(c,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(T),Ht(c,"TestPingServer: error",!1,u)})}function Ht(i,u,c,d,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),d(c)}catch{}}function tl(){this.g=new xc}function el(i,u,c){const d=c||"";try{Qi(i,function(T,R){let P=T;f(T)&&(P=Gr(T)),u.push(d+R+"="+encodeURIComponent(P))})}catch(T){throw u.push(d+"type="+encodeURIComponent("_badmap")),T}}function $n(i){this.l=i.Ub||null,this.j=i.eb||!1}V($n,Hr),$n.prototype.g=function(){return new zn(this.l,this.j)},$n.prototype.i=function(i){return function(){return i}}({});function zn(i,u){mt.call(this),this.D=i,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}V(zn,mt),n=zn.prototype,n.open=function(i,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=i,this.A=u,this.readyState=1,rn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};i&&(u.body=i),(this.D||l).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,nn(this)),this.readyState=0},n.Sa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,rn(this)),this.g&&(this.readyState=3,rn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;no(this)}else i.text().then(this.Ra.bind(this),this.ga.bind(this))};function no(i){i.j.read().then(i.Pa.bind(i)).catch(i.ga.bind(i))}n.Pa=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var u=i.value?i.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!i.done}))&&(this.response=this.responseText+=u)}i.done?nn(this):rn(this),this.readyState==3&&no(this)}},n.Ra=function(i){this.g&&(this.response=this.responseText=i,nn(this))},n.Qa=function(i){this.g&&(this.response=i,nn(this))},n.ga=function(){this.g&&nn(this)};function nn(i){i.readyState=4,i.l=null,i.j=null,i.v=null,rn(i)}n.setRequestHeader=function(i,u){this.u.append(i,u)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],u=this.h.entries();for(var c=u.next();!c.done;)c=c.value,i.push(c[0]+": "+c[1]),c=u.next();return i.join(`\r
`)};function rn(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(zn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function ro(i){let u="";return ut(i,function(c,d){u+=d,u+=":",u+=c,u+=`\r
`}),u}function ns(i,u,c){t:{for(d in c){var d=!1;break t}d=!0}d||(c=ro(c),typeof i=="string"?c!=null&&encodeURIComponent(String(c)):X(i,u,c))}function Z(i){mt.call(this),this.headers=new Map,this.o=i||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}V(Z,mt);var nl=/^https?$/i,rl=["POST","PUT"];n=Z.prototype,n.Ha=function(i){this.J=i},n.ea=function(i,u,c,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);u=u?u.toUpperCase():"GET",this.D=i,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Qr.g(),this.v=this.o?Ni(this.o):Ni(Qr),this.g.onreadystatechange=A(this.Ea,this);try{this.B=!0,this.g.open(u,String(i),!0),this.B=!1}catch(R){so(this,R);return}if(i=c||"",c=new Map(this.headers),d)if(Object.getPrototypeOf(d)===Object.prototype)for(var T in d)c.set(T,d[T]);else if(typeof d.keys=="function"&&typeof d.get=="function")for(const R of d.keys())c.set(R,d.get(R));else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(c.keys()).find(R=>R.toLowerCase()=="content-type"),T=l.FormData&&i instanceof l.FormData,!(0<=Array.prototype.indexOf.call(rl,u,void 0))||d||T||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,P]of c)this.g.setRequestHeader(R,P);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ao(this),this.u=!0,this.g.send(i),this.u=!1}catch(R){so(this,R)}};function so(i,u){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=u,i.m=5,io(i),Gn(i)}function io(i){i.A||(i.A=!0,vt(i,"complete"),vt(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=i||7,vt(this,"complete"),vt(this,"abort"),Gn(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Gn(this,!0)),Z.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?oo(this):this.bb())},n.bb=function(){oo(this)};function oo(i){if(i.h&&typeof a<"u"&&(!i.v[1]||Ft(i)!=4||i.Z()!=2)){if(i.u&&Ft(i)==4)bi(i.Ea,0,i);else if(vt(i,"readystatechange"),Ft(i)==4){i.h=!1;try{const P=i.Z();t:switch(P){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break t;default:u=!1}var c;if(!(c=u)){var d;if(d=P===0){var T=String(i.D).match(Xi)[1]||null;!T&&l.self&&l.self.location&&(T=l.self.location.protocol.slice(0,-1)),d=!nl.test(T?T.toLowerCase():"")}c=d}if(c)vt(i,"complete"),vt(i,"success");else{i.m=6;try{var R=2<Ft(i)?i.g.statusText:""}catch{R=""}i.l=R+" ["+i.Z()+"]",io(i)}}finally{Gn(i)}}}}function Gn(i,u){if(i.g){ao(i);const c=i.g,d=i.v[0]?()=>{}:null;i.g=null,i.v=null,u||vt(i,"ready");try{c.onreadystatechange=d}catch{}}}function ao(i){i.I&&(l.clearTimeout(i.I),i.I=null)}n.isActive=function(){return!!this.g};function Ft(i){return i.g?i.g.readyState:0}n.Z=function(){try{return 2<Ft(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(i){if(this.g){var u=this.g.responseText;return i&&u.indexOf(i)==0&&(u=u.substring(i.length)),Oc(u)}};function uo(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.H){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function sl(i){const u={};i=(i.g&&2<=Ft(i)&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let d=0;d<i.length;d++){if(U(i[d]))continue;var c=E(i[d]);const T=c[0];if(c=c[1],typeof c!="string")continue;c=c.trim();const R=u[T]||[];u[T]=R,R.push(c)}v(u,function(d){return d.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function sn(i,u,c){return c&&c.internalChannelParams&&c.internalChannelParams[i]||u}function co(i){this.Aa=0,this.i=[],this.j=new Ye,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=sn("failFast",!1,i),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=sn("baseRetryDelayMs",5e3,i),this.cb=sn("retryDelaySeedMs",1e4,i),this.Wa=sn("forwardChannelMaxRetries",2,i),this.wa=sn("forwardChannelRequestTimeoutMs",2e4,i),this.pa=i&&i.xmlHttpFactory||void 0,this.Xa=i&&i.Tb||void 0,this.Ca=i&&i.useFetchStreams||!1,this.L=void 0,this.J=i&&i.supportsCrossDomainXhr||!1,this.K="",this.h=new zi(i&&i.concurrentRequestLimit),this.Da=new tl,this.P=i&&i.fastHandshake||!1,this.O=i&&i.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=i&&i.Rb||!1,i&&i.xa&&this.j.xa(),i&&i.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&i&&i.detectBufferingProxy||!1,this.ja=void 0,i&&i.longPollingTimeout&&0<i.longPollingTimeout&&(this.ja=i.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=co.prototype,n.la=8,n.G=1,n.connect=function(i,u,c,d){Tt(0),this.W=i,this.H=u||{},c&&d!==void 0&&(this.H.OSID=c,this.H.OAID=d),this.F=this.X,this.I=Eo(this,null,this.W),Kn(this)};function rs(i){if(lo(i),i.G==3){var u=i.U++,c=Lt(i.I);if(X(c,"SID",i.K),X(c,"RID",u),X(c,"TYPE","terminate"),on(i,c),u=new zt(i,i.j,u),u.L=2,u.v=jn(Lt(c)),c=!1,l.navigator&&l.navigator.sendBeacon)try{c=l.navigator.sendBeacon(u.v.toString(),"")}catch{}!c&&l.Image&&(new Image().src=u.v,c=!0),c||(u.g=vo(u.j,null),u.g.ea(u.v)),u.F=Date.now(),Un(u)}yo(i)}function Hn(i){i.g&&(is(i),i.g.cancel(),i.g=null)}function lo(i){Hn(i),i.u&&(l.clearTimeout(i.u),i.u=null),Wn(i),i.h.cancel(),i.s&&(typeof i.s=="number"&&l.clearTimeout(i.s),i.s=null)}function Kn(i){if(!Gi(i.h)&&!i.s){i.s=!0;var u=i.Ga;ze||wi(),Ge||(ze(),Ge=!0),Lr.add(u,i),i.B=0}}function il(i,u){return Hi(i.h)>=i.h.j-(i.s?1:0)?!1:i.s?(i.i=u.D.concat(i.i),!0):i.G==1||i.G==2||i.B>=(i.Va?0:i.Wa)?!1:(i.s=Xe(A(i.Ga,i,u),_o(i,i.B)),i.B++,!0)}n.Ga=function(i){if(this.s)if(this.s=null,this.G==1){if(!i){this.U=Math.floor(1e5*Math.random()),i=this.U++;const T=new zt(this,this.j,i);let R=this.o;if(this.S&&(R?(R=m(R),y(R,this.S)):R=this.S),this.m!==null||this.O||(T.H=R,R=null),this.P)t:{for(var u=0,c=0;c<this.i.length;c++){e:{var d=this.i[c];if("__data__"in d.map&&(d=d.map.__data__,typeof d=="string")){d=d.length;break e}d=void 0}if(d===void 0)break;if(u+=d,4096<u){u=c;break t}if(u===4096||c===this.i.length-1){u=c+1;break t}}u=1e3}else u=1e3;u=fo(this,T,u),c=Lt(this.I),X(c,"RID",i),X(c,"CVER",22),this.D&&X(c,"X-HTTP-Session-Id",this.D),on(this,c),R&&(this.O?u="headers="+encodeURIComponent(String(ro(R)))+"&"+u:this.m&&ns(c,this.m,R)),es(this.h,T),this.Ua&&X(c,"TYPE","init"),this.P?(X(c,"$req",u),X(c,"SID","null"),T.T=!0,Yr(T,c,null)):Yr(T,c,u),this.G=2}}else this.G==3&&(i?ho(this,i):this.i.length==0||Gi(this.h)||ho(this))};function ho(i,u){var c;u?c=u.l:c=i.U++;const d=Lt(i.I);X(d,"SID",i.K),X(d,"RID",c),X(d,"AID",i.T),on(i,d),i.m&&i.o&&ns(d,i.m,i.o),c=new zt(i,i.j,c,i.B+1),i.m===null&&(c.H=i.o),u&&(i.i=u.D.concat(i.i)),u=fo(i,c,1e3),c.I=Math.round(.5*i.wa)+Math.round(.5*i.wa*Math.random()),es(i.h,c),Yr(c,d,u)}function on(i,u){i.H&&ut(i.H,function(c,d){X(u,d,c)}),i.l&&Qi({},function(c,d){X(u,d,c)})}function fo(i,u,c){c=Math.min(i.i.length,c);var d=i.l?A(i.l.Na,i.l,i):null;t:{var T=i.i;let R=-1;for(;;){const P=["count="+c];R==-1?0<c?(R=T[0].g,P.push("ofs="+R)):R=0:P.push("ofs="+R);let W=!0;for(let ct=0;ct<c;ct++){let G=T[ct].g;const pt=T[ct].map;if(G-=R,0>G)R=Math.max(0,T[ct].g-100),W=!1;else try{el(pt,P,"req"+G+"_")}catch{d&&d(pt)}}if(W){d=P.join("&");break t}}}return i=i.i.splice(0,c),u.D=i,d}function mo(i){if(!i.g&&!i.u){i.Y=1;var u=i.Fa;ze||wi(),Ge||(ze(),Ge=!0),Lr.add(u,i),i.v=0}}function ss(i){return i.g||i.u||3<=i.v?!1:(i.Y++,i.u=Xe(A(i.Fa,i),_o(i,i.v)),i.v++,!0)}n.Fa=function(){if(this.u=null,po(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var i=2*this.R;this.j.info("BP detection timer enabled: "+i),this.A=Xe(A(this.ab,this),i)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Tt(10),Hn(this),po(this))};function is(i){i.A!=null&&(l.clearTimeout(i.A),i.A=null)}function po(i){i.g=new zt(i,i.j,"rpc",i.Y),i.m===null&&(i.g.H=i.o),i.g.O=0;var u=Lt(i.qa);X(u,"RID","rpc"),X(u,"SID",i.K),X(u,"AID",i.T),X(u,"CI",i.F?"0":"1"),!i.F&&i.ja&&X(u,"TO",i.ja),X(u,"TYPE","xmlhttp"),on(i,u),i.m&&i.o&&ns(u,i.m,i.o),i.L&&(i.g.I=i.L);var c=i.g;i=i.ia,c.L=1,c.v=jn(Lt(u)),c.m=null,c.P=!0,qi(c,i)}n.Za=function(){this.C!=null&&(this.C=null,Hn(this),ss(this),Tt(19))};function Wn(i){i.C!=null&&(l.clearTimeout(i.C),i.C=null)}function go(i,u){var c=null;if(i.g==u){Wn(i),is(i),i.g=null;var d=2}else if(ts(i.h,u))c=u.D,Ki(i.h,u),d=1;else return;if(i.G!=0){if(u.o)if(d==1){c=u.m?u.m.length:0,u=Date.now()-u.F;var T=i.B;d=xn(),vt(d,new Li(d,c)),Kn(i)}else mo(i);else if(T=u.s,T==3||T==0&&0<u.X||!(d==1&&il(i,u)||d==2&&ss(i)))switch(c&&0<c.length&&(u=i.h,u.i=u.i.concat(c)),T){case 1:ue(i,5);break;case 4:ue(i,10);break;case 3:ue(i,6);break;default:ue(i,2)}}}function _o(i,u){let c=i.Ta+Math.floor(Math.random()*i.cb);return i.isActive()||(c*=2),c*u}function ue(i,u){if(i.j.info("Error code "+u),u==2){var c=A(i.fb,i),d=i.Xa;const T=!d;d=new ae(d||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Bn(d,"https"),jn(d),T?Jc(d.toString(),c):Zc(d.toString(),c)}else Tt(2);i.G=0,i.l&&i.l.sa(u),yo(i),lo(i)}n.fb=function(i){i?(this.j.info("Successfully pinged google.com"),Tt(2)):(this.j.info("Failed to ping google.com"),Tt(1))};function yo(i){if(i.G=0,i.ka=[],i.l){const u=Wi(i.h);(u.length!=0||i.i.length!=0)&&(D(i.ka,u),D(i.ka,i.i),i.h.i.length=0,M(i.i),i.i.length=0),i.l.ra()}}function Eo(i,u,c){var d=c instanceof ae?Lt(c):new ae(c);if(d.g!="")u&&(d.g=u+"."+d.g),qn(d,d.s);else{var T=l.location;d=T.protocol,u=u?u+"."+T.hostname:T.hostname,T=+T.port;var R=new ae(null);d&&Bn(R,d),u&&(R.g=u),T&&qn(R,T),c&&(R.l=c),d=R}return c=i.D,u=i.ya,c&&u&&X(d,c,u),X(d,"VER",i.la),on(i,d),d}function vo(i,u,c){if(u&&!i.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=i.Ca&&!i.pa?new Z(new $n({eb:c})):new Z(i.pa),u.Ha(i.J),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function To(){}n=To.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Qn(){}Qn.prototype.g=function(i,u){return new wt(i,u)};function wt(i,u){mt.call(this),this.g=new co(u),this.l=i,this.h=u&&u.messageUrlParams||null,i=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(i?i["X-WebChannel-Content-Type"]=u.messageContentType:i={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(i?i["X-WebChannel-Client-Profile"]=u.va:i={"X-WebChannel-Client-Profile":u.va}),this.g.S=i,(i=u&&u.Sb)&&!U(i)&&(this.g.m=i),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!U(u)&&(this.g.D=u,i=this.h,i!==null&&u in i&&(i=this.h,u in i&&delete i[u])),this.j=new ve(this)}V(wt,mt),wt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},wt.prototype.close=function(){rs(this.g)},wt.prototype.o=function(i){var u=this.g;if(typeof i=="string"){var c={};c.__data__=i,i=c}else this.u&&(c={},c.__data__=Gr(i),i=c);u.i.push(new jc(u.Ya++,i)),u.G==3&&Kn(u)},wt.prototype.N=function(){this.g.l=null,delete this.j,rs(this.g),delete this.g,wt.aa.N.call(this)};function Io(i){Kr.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var u=i.__sm__;if(u){t:{for(const c in u){i=c;break t}i=void 0}(this.i=i)&&(i=this.i,u=u!==null&&i in u?u[i]:void 0),this.data=u}else this.data=i}V(Io,Kr);function wo(){Wr.call(this),this.status=1}V(wo,Wr);function ve(i){this.g=i}V(ve,To),ve.prototype.ua=function(){vt(this.g,"a")},ve.prototype.ta=function(i){vt(this.g,new Io(i))},ve.prototype.sa=function(i){vt(this.g,new wo)},ve.prototype.ra=function(){vt(this.g,"b")},Qn.prototype.createWebChannel=Qn.prototype.g,wt.prototype.send=wt.prototype.o,wt.prototype.open=wt.prototype.m,wt.prototype.close=wt.prototype.close,Ja=function(){return new Qn},Ya=function(){return xn()},Xa=ie,Is={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ln.NO_ERROR=0,Ln.TIMEOUT=8,Ln.HTTP_ERROR=6,rr=Ln,Fi.COMPLETE="complete",Qa=Fi,ki.EventType=We,We.OPEN="a",We.CLOSE="b",We.ERROR="c",We.MESSAGE="d",mt.prototype.listen=mt.prototype.K,un=ki,Z.prototype.listenOnce=Z.prototype.L,Z.prototype.getLastError=Z.prototype.Ka,Z.prototype.getLastErrorCode=Z.prototype.Ba,Z.prototype.getStatus=Z.prototype.Z,Z.prototype.getResponseJson=Z.prototype.Oa,Z.prototype.getResponseText=Z.prototype.oa,Z.prototype.send=Z.prototype.ea,Z.prototype.setWithCredentials=Z.prototype.Ha,Wa=Z}).apply(typeof Yn<"u"?Yn:typeof self<"u"?self:typeof window<"u"?window:{});const Lo="@firebase/firestore",Fo="4.9.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he=new qa("@firebase/firestore");function Ie(){return he.logLevel}function k(n,...t){if(he.logLevel<=$.DEBUG){const e=t.map(js);he.debug(`Firestore (${Fe}): ${n}`,...e)}}function qt(n,...t){if(he.logLevel<=$.ERROR){const e=t.map(js);he.error(`Firestore (${Fe}): ${n}`,...e)}}function De(n,...t){if(he.logLevel<=$.WARN){const e=t.map(js);he.warn(`Firestore (${Fe}): ${n}`,...e)}}function js(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ue(n){if(n.code!==S.FAILED_PRECONDITION||n.message!==pd)throw n;k("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ho(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function fe(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function su(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bd=new J(O.comparator);function jt(){return Bd}const wu=new J(O.comparator);function cn(...n){let t=wu;for(const e of n)t=t.insert(e.key,e);return t}function Au(n){let t=wu;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function le(){return mn()}function Ru(){return mn()}function mn(){return new me(n=>n.toString(),(n,t)=>n.isEqual(t))}const qd=new J(O.comparator),jd=new it(O.comparator);function q(...n){let t=jd;for(const e of n)t=t.add(e);return t}const $d=new it(B);function zd(){return $d}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mf{constructor(){this.changes=new me(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,Et.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?C.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xf{constructor(t,e,r,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=s}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(s=>(r=s,this.remoteDocumentCache.getEntry(t,e))).next(s=>(r!==null&&pn(r.mutation,s,Ct.empty(),Y.now()),s))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,q()).next(()=>r))}getLocalViewOfDocuments(t,e,r=q()){const s=le();return this.populateOverlays(t,s,e).next(()=>this.computeViews(t,e,s,r).next(o=>{let a=cn();return o.forEach((l,h)=>{a=a.insert(l,h.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=le();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,q()))}populateOverlays(t,e,r){const s=[];return r.forEach(o=>{e.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(t,s).next(o=>{o.forEach((a,l)=>{e.set(a,l)})})}computeViews(t,e,r,s){let o=jt();const a=mn(),l=function(){return mn()}();return e.forEach((h,f)=>{const p=r.get(f.key);s.has(f.key)&&(p===void 0||p.mutation instanceof pe)?o=o.insert(f.key,f):p!==void 0?(a.set(f.key,p.mutation.getFieldMask()),pn(p.mutation,f,p.mutation.getFieldMask(),Y.now())):a.set(f.key,Ct.empty())}),this.recalculateAndSaveOverlays(t,o).next(h=>(h.forEach((f,p)=>a.set(f,p)),e.forEach((f,p)=>l.set(f,new Of(p,a.get(f)??null))),l))}recalculateAndSaveOverlays(t,e){const r=mn();let s=new J((a,l)=>a-l),o=q();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const l of a)l.keys().forEach(h=>{const f=e.get(h);if(f===null)return;let p=r.get(h)||Ct.empty();p=l.applyToLocalView(f,p),r.set(h,p);const I=(s.get(l.batchId)||q()).add(h);s=s.insert(l.batchId,I)})}).next(()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const h=l.getNext(),f=h.key,p=h.value,I=Ru();p.forEach(A=>{if(!o.has(A)){const b=Du(e.get(A),r.get(A));b!==null&&I.set(A,b),o=o.add(A)}}),a.push(this.documentOverlayCache.saveOverlays(t,f,I))}return C.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,s){return function(a){return O.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):vu(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,s):this.getDocumentsMatchingCollectionQuery(t,e,r,s)}getNextDocuments(t,e,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,s-o.size):C.resolve(le());let l=yn,h=o;return a.next(f=>C.forEach(f,(p,I)=>(l<I.largestBatchId&&(l=I.largestBatchId),o.get(p)?C.resolve():this.remoteDocumentCache.getEntry(t,p).next(A=>{h=h.insert(p,A)}))).next(()=>this.populateOverlays(t,f,o)).next(()=>this.computeViews(t,h,f,q())).next(p=>({batchId:l,changes:Au(p)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new O(e)).next(r=>{let s=cn();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(t,e,r,s){const o=e.collectionGroup;let a=cn();return this.indexManager.getCollectionParents(t,o).next(l=>C.forEach(l,h=>{const f=function(I,A){return new qe(A,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,f,r,s).next(p=>{p.forEach((I,A)=>{a=a.insert(I,A)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,s))).next(a=>{o.forEach((h,f)=>{const p=f.getKey();a.get(p)===null&&(a=a.insert(p,Et.newInvalidDocument(p)))});let l=cn();return a.forEach((h,f)=>{const p=o.get(h);p!==void 0&&pn(p.mutation,f,Ct.empty(),Y.now()),Pr(e,f)&&(l=l.insert(h,f))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{constructor(){this.sessionToken=dt.EMPTY_BYTE_STRING}getSessionToken(t){return C.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,C.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zs{constructor(){this.Qr=new it(ot.$r),this.Ur=new it(ot.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(t,e){const r=new ot(t,e);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(t,e){t.forEach(r=>this.addReference(r,e))}removeReference(t,e){this.Gr(new ot(t,e))}zr(t,e){t.forEach(r=>this.removeReference(r,e))}jr(t){const e=new O(new Q([])),r=new ot(e,t),s=new ot(e,t+1),o=[];return this.Ur.forEachInRange([r,s],a=>{this.Gr(a),o.push(a.key)}),o}Jr(){this.Qr.forEach(t=>this.Gr(t))}Gr(t){this.Qr=this.Qr.delete(t),this.Ur=this.Ur.delete(t)}Hr(t){const e=new O(new Q([])),r=new ot(e,t),s=new ot(e,t+1);let o=q();return this.Ur.forEachInRange([r,s],a=>{o=o.add(a.key)}),o}containsKey(t){const e=new ot(t,0),r=this.Qr.firstAfterOrEqual(e);return r!==null&&t.isEqual(r.key)}}class ot{constructor(t,e){this.key=t,this.Yr=e}static $r(t,e){return O.comparator(t.key,e.key)||B(t.Yr,e.Yr)}static Kr(t,e){return B(t.Yr,e.Yr)||O.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bf{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.tr=1,this.Zr=new it(ot.$r)}checkEmpty(t){return C.resolve(this.mutationQueue.length===0)}addMutationBatch(t,e,r,s){const o=this.tr;this.tr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new tf(o,e,r,s);this.mutationQueue.push(a);for(const l of s)this.Zr=this.Zr.add(new ot(l.key,o)),this.indexManager.addToCollectionParentIndex(t,l.key.path.popLast());return C.resolve(a)}lookupMutationBatch(t,e){return C.resolve(this.Xr(e))}getNextMutationBatchAfterBatchId(t,e){const r=e+1,s=this.ei(r),o=s<0?0:s;return C.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return C.resolve(this.mutationQueue.length===0?zs:this.tr-1)}getAllMutationBatches(t){return C.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const r=new ot(e,0),s=new ot(e,Number.POSITIVE_INFINITY),o=[];return this.Zr.forEachInRange([r,s],a=>{const l=this.Xr(a.Yr);o.push(l)}),C.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(t,e){let r=new it(B);return e.forEach(s=>{const o=new ot(s,0),a=new ot(s,Number.POSITIVE_INFINITY);this.Zr.forEachInRange([o,a],l=>{r=r.add(l.Yr)})}),C.resolve(this.ti(r))}getAllMutationBatchesAffectingQuery(t,e){const r=e.path,s=r.length+1;let o=r;O.isDocumentKey(o)||(o=o.child(""));const a=new ot(new O(o),0);let l=new it(B);return this.Zr.forEachWhile(h=>{const f=h.key.path;return!!r.isPrefixOf(f)&&(f.length===s&&(l=l.add(h.Yr)),!0)},a),C.resolve(this.ti(l))}ti(t){const e=[];return t.forEach(r=>{const s=this.Xr(r);s!==null&&e.push(s)}),e}removeMutationBatch(t,e){H(this.ni(e.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Zr;return C.forEach(e.mutations,s=>{const o=new ot(s.key,e.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(t,s.key)}).next(()=>{this.Zr=r})}ir(t){}containsKey(t,e){const r=new ot(e,0),s=this.Zr.firstAfterOrEqual(r);return C.resolve(e.isEqual(s&&s.key))}performConsistencyCheck(t){return this.mutationQueue.length,C.resolve()}ni(t,e){return this.ei(t)}ei(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Xr(t){const e=this.ei(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hf{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return Ol()?8:_d(kl())>0?6:4}()}initialize(t,e){this.ps=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,r,s){const o={result:null};return this.ys(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.ws(t,e,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Gf;return this.Ss(t,e,a).next(l=>{if(o.result=l,this.Vs)return this.bs(t,e,a,l.size)})}).next(()=>o.result)}bs(t,e,r,s){return r.documentReadCount<this.fs?(Ie()<=$.DEBUG&&k("QueryEngine","SDK will not create cache indexes for query:",we(e),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),C.resolve()):(Ie()<=$.DEBUG&&k("QueryEngine","Query:",we(e),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(Ie()<=$.DEBUG&&k("QueryEngine","The SDK decides to create cache indexes for query:",we(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Vt(e))):C.resolve())}ys(t,e){if(na(e))return C.resolve(null);let r=Vt(e);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(e.limit!==null&&s===1&&(e=Ps(e,null,"F"),r=Vt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=q(...o);return this.ps.getDocuments(t,a).next(l=>this.indexManager.getMinOffset(t,r).next(h=>{const f=this.Ds(e,l);return this.Cs(e,f,a,h.readTime)?this.ys(t,Ps(e,null,"F")):this.vs(t,f,e,h)}))})))}ws(t,e,r,s){return na(e)||s.isEqual(L.min())?C.resolve(null):this.ps.getDocuments(t,r).next(o=>{const a=this.Ds(e,o);return this.Cs(e,a,r,s)?C.resolve(null):(Ie()<=$.DEBUG&&k("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),we(e)),this.vs(t,a,e,dd(s,yn)).next(l=>l))})}Ds(t,e){let r=new it(Iu(t));return e.forEach((s,o)=>{Pr(t,o)&&(r=r.add(o))}),r}Cs(t,e,r,s){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Ss(t,e,r){return Ie()<=$.DEBUG&&k("QueryEngine","Using full collection scan to execute query:",we(e)),this.ps.getDocumentsMatchingQuery(t,e,Zt.min(),r)}vs(t,e,r,s){return this.ps.getDocumentsMatchingQuery(t,r,s).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs="RestConnection",sm={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class im{get $o(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Uo=e+"://"+t.host,this.Ko=`projects/${r}/databases/${s}`,this.Wo=this.databaseId.database===pr?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Go(t,e,r,s,o){const a=Os(),l=this.zo(t,e.toUriEncodedString());k(fs,`Sending RPC '${t}' ${a}:`,l,r);const h={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(h,s,o);const{host:f}=new URL(l),p=Bs(f);return this.Jo(t,l,h,r,p).then(I=>(k(fs,`Received RPC '${t}' ${a}: `,I),I),I=>{throw De(fs,`RPC '${t}' ${a} failed with error: `,I,"url: ",l,"request:",r),I})}Ho(t,e,r,s,o,a){return this.Go(t,e,r,s,o)}jo(t,e,r){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Fe}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((s,o)=>t[o]=s),r&&r.headers.forEach((s,o)=>t[o]=s)}zo(t,e){const r=sm[t];return`${this.Uo}/v1/${e}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="WebChannelConnection";class am extends im{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,r,s,o){const a=Os();return new Promise((l,h)=>{const f=new Wa;f.setWithCredentials(!0),f.listenOnce(Qa.COMPLETE,()=>{try{switch(f.getLastErrorCode()){case rr.NO_ERROR:const I=f.getResponseJson();k(_t,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(I)),l(I);break;case rr.TIMEOUT:k(_t,`RPC '${t}' ${a} timed out`),h(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case rr.HTTP_ERROR:const A=f.getStatus();if(k(_t,`RPC '${t}' ${a} failed with status:`,A,"response text:",f.getResponseText()),A>0){let b=f.getResponseJson();Array.isArray(b)&&(b=b[0]);const V=b==null?void 0:b.error;if(V&&V.status&&V.message){const M=function(K){const U=K.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(U)>=0?U:S.UNKNOWN}(V.status);h(new N(M,V.message))}else h(new N(S.UNKNOWN,"Server responded with status "+f.getStatus()))}else h(new N(S.UNAVAILABLE,"Connection failed."));break;default:x(9055,{l_:t,streamId:a,h_:f.getLastErrorCode(),P_:f.getLastError()})}}finally{k(_t,`RPC '${t}' ${a} completed.`)}});const p=JSON.stringify(s);k(_t,`RPC '${t}' ${a} sending request:`,s),f.send(e,"POST",p,r,15)})}T_(t,e,r){const s=Os(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Ja(),l=Ya(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const p=o.join("");k(_t,`Creating RPC '${t}' stream ${s}: ${p}`,h);const I=a.createWebChannel(p,h);this.I_(I);let A=!1,b=!1;const V=new om({Yo:D=>{b?k(_t,`Not sending because RPC '${t}' stream ${s} is closed:`,D):(A||(k(_t,`Opening RPC '${t}' stream ${s} transport.`),I.open(),A=!0),k(_t,`RPC '${t}' stream ${s} sending:`,D),I.send(D))},Zo:()=>I.close()}),M=(D,K,U)=>{D.listen(K,z=>{try{U(z)}catch(et){setTimeout(()=>{throw et},0)}})};return M(I,un.EventType.OPEN,()=>{b||(k(_t,`RPC '${t}' stream ${s} transport opened.`),V.o_())}),M(I,un.EventType.CLOSE,()=>{b||(b=!0,k(_t,`RPC '${t}' stream ${s} transport closed`),V.a_(),this.E_(I))}),M(I,un.EventType.ERROR,D=>{b||(b=!0,De(_t,`RPC '${t}' stream ${s} transport errored. Name:`,D.name,"Message:",D.message),V.a_(new N(S.UNAVAILABLE,"The operation could not be completed")))}),M(I,un.EventType.MESSAGE,D=>{var K;if(!b){const U=D.data[0];H(!!U,16349);const z=U,et=(z==null?void 0:z.error)||((K=z[0])==null?void 0:K.error);if(et){k(_t,`RPC '${t}' stream ${s} received error:`,et);const Ot=et.status;let ut=function(_){const y=nt[_];if(y!==void 0)return Mu(y)}(Ot),v=et.message;ut===void 0&&(ut=S.INTERNAL,v="Unknown error status: "+Ot+" with message "+et.message),b=!0,V.a_(new N(ut,v)),I.close()}else k(_t,`RPC '${t}' stream ${s} received:`,U),V.u_(U)}}),M(l,Xa.STAT_EVENT,D=>{D.stat===Is.PROXY?k(_t,`RPC '${t}' stream ${s} detected buffering proxy`):D.stat===Is.NOPROXY&&k(_t,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{V.__()},0),V}terminate(){this.c_.forEach(t=>t.close()),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter(e=>e===t)}}function ms(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const de="RemoteStore";class fm{constructor(t,e,r,s,o){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo(a=>{r.enqueueAndForget(async()=>{ge(this)&&(k(de,"Restarting streams for network reachability change."),await async function(h){const f=F(h);f.Ea.add(4),await Vn(f),f.Ra.set("Unknown"),f.Ea.delete(4),await Mr(f)}(this))})}),this.Ra=new dm(r,s)}}async function Mr(n){if(ge(n))for(const t of n.da)await t(!0)}async function Vn(n){for(const t of n.da)await t(!1)}function Xu(n,t){const e=F(n);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),oi(e)?ii(e):je(e).O_()&&si(e,t))}function ri(n,t){const e=F(n),r=je(e);e.Ia.delete(t),r.O_()&&Yu(e,t),e.Ia.size===0&&(r.O_()?r.L_():ge(e)&&e.Ra.set("Unknown"))}function si(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(L.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}je(n).Y_(t)}function Yu(n,t){n.Va.Ue(t),je(n).Z_(t)}function ii(n){n.Va=new af({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),je(n).start(),n.Ra.ua()}function oi(n){return ge(n)&&!je(n).x_()&&n.Ia.size>0}function ge(n){return F(n).Ea.size===0}function Ju(n){n.Va=void 0}async function mm(n){n.Ra.set("Online")}async function pm(n){n.Ia.forEach((t,e)=>{si(n,t)})}async function gm(n,t){Ju(n),oi(n)?(n.Ra.ha(t),ii(n)):n.Ra.set("Unknown")}async function _m(n,t,e){if(n.Ra.set("Online"),t instanceof xu&&t.state===2&&t.cause)try{await async function(s,o){const a=o.cause;for(const l of o.targetIds)s.Ia.has(l)&&(await s.remoteSyncer.rejectListen(l,a),s.Ia.delete(l),s.Va.removeTarget(l))}(n,t)}catch(r){k(de,"Failed to remove targets %s: %s ",t.targetIds.join(","),r),await Tr(n,r)}else if(t instanceof ar?n.Va.Ze(t):t instanceof Ou?n.Va.st(t):n.Va.tt(t),!e.isEqual(L.min()))try{const r=await Ku(n.localStore);e.compareTo(r)>=0&&await function(o,a){const l=o.Va.Tt(a);return l.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.Ia.get(f);p&&o.Ia.set(f,p.withResumeToken(h.resumeToken,a))}}),l.targetMismatches.forEach((h,f)=>{const p=o.Ia.get(h);if(!p)return;o.Ia.set(h,p.withResumeToken(dt.EMPTY_BYTE_STRING,p.snapshotVersion)),Yu(o,h);const I=new Kt(p.target,h,f,p.sequenceNumber);si(o,I)}),o.remoteSyncer.applyRemoteEvent(l)}(n,e)}catch(r){k(de,"Failed to raise snapshot:",r),await Tr(n,r)}}async function Tr(n,t,e){if(!Be(t))throw t;n.Ea.add(1),await Vn(n),n.Ra.set("Offline"),e||(e=()=>Ku(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{k(de,"Retrying IndexedDB access"),await e(),n.Ea.delete(1),await Mr(n)})}function Zu(n,t){return t().catch(e=>Tr(n,e,t))}async function Or(n){const t=F(n),e=re(t);let r=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:zs;for(;ym(t);)try{const s=await Zf(t.localStore,r);if(s===null){t.Ta.length===0&&e.L_();break}r=s.batchId,Em(t,s)}catch(s){await Tr(t,s)}tc(t)&&ec(t)}function ym(n){return ge(n)&&n.Ta.length<10}function Em(n,t){n.Ta.push(t);const e=re(n);e.O_()&&e.X_&&e.ea(t.mutations)}function tc(n){return ge(n)&&!re(n).x_()&&n.Ta.length>0}function ec(n){re(n).start()}async function vm(n){re(n).ra()}async function Tm(n){const t=re(n);for(const e of n.Ta)t.ea(e.mutations)}async function Im(n,t,e){const r=n.Ta.shift(),s=Xs.from(r,t,e);await Zu(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Or(n)}async function wm(n,t){t&&re(n).X_&&await async function(r,s){if(function(a){return rf(a)&&a!==S.ABORTED}(s.code)){const o=r.Ta.shift();re(r).B_(),await Zu(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s)),await Or(r)}}(n,t),tc(n)&&ec(n)}async function va(n,t){const e=F(n);e.asyncQueue.verifyOperationInProgress(),k(de,"RemoteStore received new credentials");const r=ge(e);e.Ea.add(3),await Vn(e),r&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await Mr(e)}async function Am(n,t){const e=F(n);t?(e.Ea.delete(2),await Mr(e)):t||(e.Ea.add(2),await Vn(e),e.Ra.set("Unknown"))}function je(n){return n.ma||(n.ma=function(e,r,s){const o=F(e);return o.sa(),new um(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:mm.bind(null,n),t_:pm.bind(null,n),r_:gm.bind(null,n),H_:_m.bind(null,n)}),n.da.push(async t=>{t?(n.ma.B_(),oi(n)?ii(n):n.Ra.set("Unknown")):(await n.ma.stop(),Ju(n))})),n.ma}function re(n){return n.fa||(n.fa=function(e,r,s){const o=F(e);return o.sa(),new cm(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:vm.bind(null,n),r_:wm.bind(null,n),ta:Tm.bind(null,n),na:Im.bind(null,n)}),n.da.push(async t=>{t?(n.fa.B_(),await Or(n)):(await n.fa.stop(),n.Ta.length>0&&(k(de,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new _e(this.firestore,t,this._query)}}class at{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Jt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new at(this.firestore,t,this._key)}toJSON(){return{type:at._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,r){if(Cn(e,at._jsonSchema))return new at(t,r||null,new O(Q.fromString(e.referencePath)))}}at._jsonSchemaVersion="firestore/documentReference/1.0",at._jsonSchema={type:st("string",at._jsonSchemaVersion),referencePath:st("string")};class Jt extends _e{constructor(t,e,r){super(t,e,Eu(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new at(this.firestore,null,new O(t))}withConverter(t){return new Jt(this.firestore,t,this._path)}}function Va(n,t,...e){if(n=Ve(n),eu("collection","path",t),n instanceof xr){const r=Q.fromString(t,...e);return jo(r),new Jt(n,null,r)}{if(!(n instanceof at||n instanceof Jt))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Q.fromString(t,...e));return jo(r),new Jt(n.firestore,null,r)}}function rp(n,t,...e){if(n=Ve(n),arguments.length===1&&(t=$s.newId()),eu("doc","path",t),n instanceof xr){const r=Q.fromString(t,...e);return qo(r),new at(n,null,new O(r))}{if(!(n instanceof at||n instanceof Jt))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Q.fromString(t,...e));return qo(r),new at(n.firestore,n instanceof Jt?n.converter:null,new O(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Ep(n,t,e){let r;return r=n?n.toFirestore(t):t,r}class nr{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class be extends vc{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new ur(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(yi("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new N(S.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t=this._document,e={};return e.type=be._jsonSchemaVersion,e.bundle="",e.bundleSource="DocumentSnapshot",e.bundleName=this._key.toString(),!t||!t.isValidDocument()||!t.isFoundDocument()?e:(this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields,"previous"),e.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),e)}}be._jsonSchemaVersion="firestore/documentSnapshot/1.0",be._jsonSchema={type:st("string",be._jsonSchemaVersion),bundleSource:st("string","DocumentSnapshot"),bundleName:st("string"),bundle:st("string")};class ur extends be{data(t={}){return super.data(t)}}class Pe{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new nr(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new ur(this._firestore,this._userDataWriter,r.key,r,new nr(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new N(S.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(l=>{const h=new ur(s._firestore,s._userDataWriter,l.doc.key,l.doc,new nr(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);return l.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(l=>o||l.type!==3).map(l=>{const h=new ur(s._firestore,s._userDataWriter,l.doc.key,l.doc,new nr(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);let f=-1,p=-1;return l.type!==0&&(f=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:vp(l.type),doc:h,oldIndex:f,newIndex:p}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new N(S.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t={};t.type=Pe._jsonSchemaVersion,t.bundleSource="QuerySnapshot",t.bundleName=$s.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const e=[],r=[],s=[];return this.docs.forEach(o=>{o._document!==null&&(e.push(o._document),r.push(this._userDataWriter.convertObjectMap(o._document.data.value.mapValue.fields,"previous")),s.push(o.ref.path))}),t.bundle=(this._firestore,this.query._query,t.bundleName,"NOT SUPPORTED"),t}}function vp(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return x(61501,{type:n})}}Pe._jsonSchemaVersion="firestore/querySnapshot/1.0",Pe._jsonSchema={type:st("string",Pe._jsonSchemaVersion),bundleSource:st("string","QuerySnapshot"),bundleName:st("string"),bundle:st("string")};class Tp extends yp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Rt(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new at(this.firestore,null,e)}}function Ip(n){n=fr(n,_e);const t=fr(n.firestore,di),e=fc(t),r=new Tp(t);return pp(n._query),ep(e,n._query).then(s=>new Pe(t,r,n,s))}function wp(n,t){const e=fr(n.firestore,di),r=rp(n),s=Ep(n.converter,t);return Ap(e,[cp(pc(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Ut.exists(!1))]).then(()=>r)}function Ap(n,t){return function(r,s){const o=new Yt;return r.asyncQueue.enqueueAndForget(async()=>qm(await Zm(r),s,o)),o.promise}(fc(n),t)}function Rp(){return new gi("serverTimestamp")}(function(t,e=!0){(function(s){Fe=s})(qh),dr(new gn("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new di(new rd(r.getProvider("auth-internal")),new od(a,r.getProvider("app-check-internal")),function(f,p){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new vn(f.options.projectId,p)}(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),Se(Lo,Fo,t),Se(Lo,Fo,"esm2020")})();const gs={apiKey:"AIzaSyDevIFGJaMxRqOC1jmzX4Ucj7KpscqWaFY",authDomain:"wedding-33caf.firebaseapp.com",projectId:"wedding-33caf",storageBucket:"wedding-33caf.firebasestorage.app",messagingSenderId:"392686404524",appId:"1:392686404524:web:1e500d4bf714a4ea8df009",measurementId:"G-C3DYN2JQ6W"};class Sp{constructor(){an(this,"app");an(this,"db");an(this,"isFirebaseConfigured",!1);an(this,"initPromise");this.initPromise=this.initializeFirebase()}async initializeFirebase(){try{gs&&gs.apiKey?(this.app=za(gs),this.db=sp(this.app),this.isFirebaseConfigured=!0,console.log("Firebase가 성공적으로 초기화되었습니다.")):console.log("Firebase 설정이 없습니다. 로컬 저장소를 사용합니다.")}catch(t){console.warn("Firebase 초기화 실패:",t),this.isFirebaseConfigured=!1}}async addEntry(t,e){if(await this.initPromise,!this.isFirebaseConfigured)return this.addEntryLocal(t,e);try{return await wp(Va(this.db,"guestbook"),{name:t,message:e,timestamp:Rp()}),!0}catch(r){return console.error("방명록 저장 실패:",r),this.addEntryLocal(t,e)}}async getEntries(){if(await this.initPromise,!this.isFirebaseConfigured)return this.getEntriesLocal();try{const t=gp(Va(this.db,"guestbook"),_p("timestamp","desc"));return(await Ip(t)).docs.map(r=>({id:r.id,...r.data()}))}catch(t){return console.error("방명록 로딩 실패:",t),this.getEntriesLocal()}}addEntryLocal(t,e){try{const r=this.getEntriesLocal(),s={id:Date.now().toString(),name:t,message:e,timestamp:new Date};return r.unshift(s),localStorage.setItem("wedding-guestbook",JSON.stringify(r)),!0}catch(r){return console.error("로컬 저장 실패:",r),!1}}getEntriesLocal(){try{const t=localStorage.getItem("wedding-guestbook");return t?JSON.parse(t):[]}catch(t){return console.error("로컬 데이터 로딩 실패:",t),[]}}}const wc=new Sp;function Cp(){return setTimeout(()=>{bp(),Ac()},100),`
  ...
  `}document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("app");n&&(n.innerHTML=Vp(),Dp(),Np(),ml())});function Dp(){console.log("Gallery initialized")}function Np(){document.querySelectorAll('a[href^="#"]').forEach(n=>{n.addEventListener("click",t=>{t.preventDefault();const e=t.currentTarget.getAttribute("href");if(e){const r=document.querySelector(e);r&&r.scrollIntoView({behavior:"smooth",block:"start"})}})})}
